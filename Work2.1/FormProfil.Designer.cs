namespace Work2._1
{
	partial class FormProfil
	{
		...
		private void InitializeComponent()
		{
			...
			this.cBoxClientManager.TabIndex = 3;
			// 
			// tbClientTelNumber
			// 
			...
			this.tbClientTelNumber.TabIndex = 4;
			this.tbClientTelNumber.KeyPress += new System.Windows.Forms.KeyPressEventHandler(this.tbClientTelNumber_KeyPress);
			// 
			// label4
			// 
			...
			this.tBoxCiientFName.TabIndex = 0;
			// 
			// label1
			// 
